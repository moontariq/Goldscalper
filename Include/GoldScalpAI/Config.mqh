...
private:
   ...
   double m_max_equity_drawdown_percent;
...
public:
   CGSAConfig(void) : m_magic_number(GSA_DEFAULT_MAGIC),m_risk_percent(1.0),
                      ...
                      m_max_equity_drawdown_percent(5.0),
                      m_max_open_positions(1),m_allow_trading(false) {}

   bool Initialize(const long magic_number,const double risk_percent,
                   const double max_daily_loss_percent,const double max_equity_drawdown_percent,
                   ...
                   const int max_open_positions,const bool allow_trading)
     {
      ...
      if(max_daily_loss_percent<GSA_MIN_DAILY_LOSS_PERCENT ||
         ...
         return false;
      if(max_equity_drawdown_percent<GSA_MIN_DAILY_LOSS_PERCENT ||
         max_equity_drawdown_percent>GSA_MAX_DAILY_LOSS_PERCENT)
         return false;
      ...
      m_max_equity_drawdown_percent=max_equity_drawdown_percent;
   ...
   double MaxEquityDrawdownPercent(void) const { return m_max_equity_drawdown_percent; }
